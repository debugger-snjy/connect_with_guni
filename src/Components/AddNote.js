        ...
        <div className="container">
            ...
            <form className='my-3' id='addNoteForm'>
                ...
                <div className="mb-3">
                    ...
                    <div id="tagHelp" className="form-text" style={{fontSize : "16px", fontWeight : "bold", marginTop : "10px", color : "grey"}}> <i className="fa-solid fa-circle-exclamation fa-lg" style={{"color": "rgb(71, 74, 78)"}}></i> If you want to add more than one tag, then use the <strong>commas</strong> in between. (Eg : Medicines,Home,Health are 3 different Tags)</div>
                </div>
