...
function FacultyDashboard() {
    ...
    if (!sessionStorage.getItem("user") && !sessionStorage.getItem("token") && !sessionStorage.getItem("role") === "faculty") {
    ...
    useEffect(() => {
        ...
        if (!sessionStorage.getItem("token") && !sessionStorage.getItem("role") === "faculty") {
